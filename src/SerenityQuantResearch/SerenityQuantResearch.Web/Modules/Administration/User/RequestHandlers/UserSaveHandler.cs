    ...
    : SaveRequestHandler<MyRow>(context), IUserSaveHandler
{
    ...
    protected override void ValidateRequest()
    {
        ...
        if (Row.IsAssigned(Fld.ActorType) && !UserActorTypes.All.Contains(Row.ActorType))
            throw new ValidationError("InvalidActorType", "ActorType", "Actor type must be 'human' or 'machine'.");
    ...
    protected override void SetInternalFields()
    {
        ...
        {
            Row.Source = "site";
            Row.ActorType ??= UserActorTypes.Human;
