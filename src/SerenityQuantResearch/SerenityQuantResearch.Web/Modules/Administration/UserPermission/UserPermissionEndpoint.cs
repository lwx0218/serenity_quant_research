using MyRepository = SerenityQuantResearch.Administration.Repositories.UserPermissionRepository;
using MyRow = SerenityQuantResearch.Administration.UserPermissionRow;
