...
> **中文归档说明（2026-08-28）**
>
> 本文件是 Research Experience Reboot 之前的历史 Plan 原文，保留英文正文以维持当时审计语境和可追溯性。它不再授权当前实现、legacy P4/P5/P6，或任何后续 Round。当前权威为 `operations/planning/research-experience-reboot.md`，Review/scope 标准为 `operations/orchestration/independent-review-and-round-scope-standard.md`。
>
